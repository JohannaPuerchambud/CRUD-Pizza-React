...
const ShowIngredientes = () => {
    ...
    const handleStateChange = (e) => {
        setIngState(e.target.value === 'true');
    };
    ...
    const validateForm = () => {
        ...
        if (!ing_calories.trim()) {
            showAlert('Escribe las calorias del ingrediente', 'warning');
            return false;
        }
        if (ing_state !== true && ing_state !== false) {
            showAlert('Escribe el estado del ingrediente', 'warning');
            return false;
        }
        return true;
    };
    ...
    const handleFormSubmit = () => {
        ...
        const parametros = {
            ...
            ing_state: ing_state,
            ing_id: operation === 2 ? ing_id : undefined
        };
    ...
    const deleteIngrediente = (ing_id, ing_name) => {
        ...
        Swal.fire({
            title: `¿Seguro de eliminar el ingrediente ${ing_name}?`,
            icon: 'question',
            ...
            if (result.isConfirmed) {
                ...
                showAlert('El ingrediente NO fue eliminado', 'info');
            }
        });
    }
